...
Therefore, the 5-minute interval beginning at `r max_interval$interval` contains
...
Therefore, there are `r incomplete_count[["FALSE"]]` missing values in the 
dataset.
...
```{r total-steps-per-day-with-imputed-data}
...
|                   | Mean                          | Median                          |
| ----------------- | ----------------------------- | ------------------------------- |
| With missing data | `r mean_steps_per_day`        | `r median_steps_per_day`        |
| With imputed data | `r mean_steps_per_day_filled` | `r median_steps_per_day_filled` |
...
```{r average-steps-per-interval-by-weekday}
